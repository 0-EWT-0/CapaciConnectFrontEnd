...
const initialRoles: Rol[] = [
  ...
  },
  {
    ...
    nombre: 'Cordinator',
    descripcion:
      'Gestión de Talleres, Vinculación de contenido Multimedia, Gestión de Calendario, Validación y respuesta a Reportes',
  },
  {
    id: 3,
    nombre: 'Instructor',
    descripcion:
      'Edición de talleres, Actualización del Progreso de participantes, Subida de contenido multimedia, Gestión de comentarios de talleres',
  },
  {
    id: 4,
    nombre: 'Participantes',
    descripcion:
      'Subscripción y talleres, Seguimiento de su Progreso, Envío de comentarios y valoración, Generación de Reporte',
  },
  {
    id: 5,
