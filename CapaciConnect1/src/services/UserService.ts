...
const handleError = async (error: any, context: string) => {
  ...
  export const updateUserService = async(userId: number, userData: any) => {
    try {
      const response = await genericRequestAuth(`${base_url}/User/UpdateUser/${userId}`, 'PATCH', userData)
      return response
    } catch (error: any) {
  ...
  export const getCommentsByWorkshopIdService = async (id_workshop_id: number) => {
    try {
      const response = await genericRequestAuth(`${base_url}/Comment/CommentByWorkshopId/${id_workshop_id}`, 'GET')
  ...
  //crear comentario
  export const createCommentService = async(commentData: { comment: string; id_workshop_id: number }) => {
    try {
      const response = await genericRequestAuth(`${base_url}/Comment/CreateComment`, 'POST', commentData)
      return response.data
    } catch (error: any) {
  ...
  //Editar Comentario
  export const updateCommentService = async(id_comment: number, updatedComment: { comment: string }) => {
    try {
      const response = await genericRequestAuth(`${base_url}/Comment/UpdateComment/${id_comment}`, 'PUT', updatedComment)
      return response.data
    } catch (error: any) {
  ...
  export const deleteCommentService = async (id_comment: number) => {
    try {
      const response = await genericRequestAuth(`${base_url}/Comment/DeleteComment/${id_comment}`, 'DELETE')
      return response.data
    } catch (error: any) {
  ...
  export const subscribeWorkshopService = async (subscriptionData: { id_workshop_id: number }) => {
    try {
      const response = await genericRequestAuth(`${base_url}/Subscription/Subscribe`, 'POST', subscriptionData)
      return response.data;
    } catch (error: any) {
  ...
  export const fetchCalendarsByWorkshopIdService  = async(id_workshop_id: number) => {
    try {
      const response = await genericRequestAuth(`${base_url}/Calendar/CalendarsByWorkshopId/${id_workshop_id}`, 'GET')
      return response.data || []
    } catch (error: any) {
      await handleError(error, 'subscribeWorkshopService');
     }
