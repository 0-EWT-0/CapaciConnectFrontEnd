<template>
    ...
    <form @submit.prevent="handleSubmit" class="p-4 sm:p-6">
        ...
        <!-- Contraseña -->
        <div class="space-y-2">
            <label class="block text-sm sm:text-base font-medium text-gray-700">Nueva Contraseña</label>
            <input
            type="password"
        ...
        <div class="space-y-2">
            <label class="block text-sm sm:text-base font-medium text-gray-700">Confirmar Nueva Contraseña</label>
            <input
            type="password"
