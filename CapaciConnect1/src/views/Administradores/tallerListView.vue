...
const talleres = ref([
  {
    ...
    descripcion:
      'Exploración de técnicas modernas de pintura con materiales no convencionales. Ideal para principiantes y entusiastas del arte contemporáneo.',
  ...
  },
  {
    ...
    descripcion:
      'Introducción al tallado en madera con herramientas profesionales y medidas de seguridad. Aprende a crear tus primeras piezas artesanales.',
    tipoTaller: 'Virtual',
  ...
  },
  {
    ...
    descripcion:
      'Dominio de técnicas profesionales de iluminación y composición. Workshop práctico con modelos reales y diferentes escenarios.',
    tipoTaller: 'Mixto',
  ...
  },
  {
    ...
    descripcion:
      'Creación de piezas únicas con técnicas tradicionales y modernas de cerámica. Incluye horneado y acabados finales.',
    tipoTaller: 'Presencial',
