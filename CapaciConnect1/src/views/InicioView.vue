  ...
  <Carousel :value="images" :numVisible="1" :numScroll="1" :circular="true" :autoplayInterval="3000">
    <template #item="slotProps">
      <div class="flex justify-center items-center">
        <img :src="slotProps.data.src" :alt="slotProps.data.alt" class="w-[110rem] h-[30rem] rounded-lg shadow-xl">
        ...
        <!-- Contenedor de tarjetas en formato grid -->
         <div class="flex flex-col items-center">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 justify-center p-5">
                <!-- Tarjeta 1 -->
                <div v-for="index in 3" :key="index" class="flex flex-col justify-between h-[20rem] w-[25rem] bg-gray-200 text-black font-bold text-2xl rounded-lg shadow-md overflow-hidden">
    ...
    <RouterLink to="/Talleres">
        ...
        <div class="flex flex-col items-center m-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-10 py-10">
                <!-- Tarjeta 1 -->
                <div v-for="index in 6" :key="index" class="flex justify-center items-center h-[5rem] w-[20rem] bg-[#33415C] text-white font-bold text-xl rounded-lg shadow-md">
        ...
        <!-- Contenedor de tarjetas en formato grid -->
         <div class="flex flex-col items-center">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 justify-center p-5">
                ...
                <!-- Tarjeta 1 -->
                <div v-for="index in 3" :key="index" class="flex flex-col items-center justify-center h-[25rem] w-[15rem] bg-gray-200 text-black font-bold text-2xl rounded-lg shadow-md overflow-hidden">
                    <div class="flex flex-col items-center justify-center p-5 text-center">
                        ...
                        <span class="h-12 w-12 rounded-full bg-[#059669] flex items-center justify-center text-white text-xl mt-2">01</span>
